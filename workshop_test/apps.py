"""
workshop_test appComponent module.

This is the module of workshop_test containing DALiuGE application components.
...
# @param[in] param/appclass Application Class/workshop_test.MyApp/String/readonly/
