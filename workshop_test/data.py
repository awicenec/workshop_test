"""
workshop_test component module.

This is the module of workshop_test containing DALiuGE data components.
...
# @param[in] param/appclass Drop Class/workshop_test.MyData/String/readonly/
